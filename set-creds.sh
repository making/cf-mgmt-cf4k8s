...
vault kv put /concourse/${TEAM}/${PIPELINE}/git_repo_uri value=https://github.com/making/cf-mgmt-cf4k8s
...
vault kv put /concourse/${TEAM}/${PIPELINE}/system_domain value=cf.maki.lol
...
vault kv put /concourse/${TEAM}/${PIPELINE}/log_level value=info
